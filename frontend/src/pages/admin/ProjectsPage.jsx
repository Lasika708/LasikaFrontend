...
const ProjectsPage = () => {
  ...
  return (
    <div>
      ...
      >
        <div>
          <h1 className="text-4xl font-bold text-gray-900 mb-2 font-display">Projects Management</h1>
      ...
      <AnimatePresence>
        {showForm && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <h2 className="text-2xl font-semibold mb-6 text-gray-900 font-display">Add New Project</h2>
                  ...
                  {projects.length === 0 ? (
                    ...
                    >
                      <td colSpan="4" className="px-6 py-12 text-center text-gray-500">
                        ...
                        <p className="text-lg">No projects found. Add your first project!</p>
                      </td>
                    </motion.tr>
                  ) : (
